...
class FlyingCube():
    ...
    def __init__(self, dt, world, prim_path="/World/random_cube", name="fancy_cube", position=np.array([0, 0, 1.0]), scale=np.array([0.1015, 0.1015, 0.1015]), color=np.array([0, 0, 1.0])):
